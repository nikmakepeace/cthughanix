...
- Different interfaces:
  ...
  - On-term - xcthugha with text-on-term or a server-mode frontend.
  - Extern - a new interface program(s) communicating with xcthugha.

### Sound Related Stuff

- Closing after an out-of-process player sometimes left the terminal in a bad
  state; using ^C behaved differently.
- Support for more input formats. Make it easier to include new decoders.
