...
public:
    ImageBackground()
        : CoreOptionEntry("image", "show image", 1) { }
    ...
    int operator()() {
        ...
        glLoadIdentity();
        glOrtho(0.0, disp_size.x, 0.0, disp_size.y, -1.0, 1.0);
        ...
        glVertex2i(0, disp_size.y);
        glTexCoord2f(1.0, 0.0);
        glVertex2i(disp_size.x, disp_size.y);
        glTexCoord2f(1.0, 1.0);
        glVertex2i(disp_size.x, 0);
        glEnd();
...
public:
    ImageBlendBackground()
        : CoreOptionEntry("image-blend", "show image blended", 1) { }
...
public:
    BlackBackground()
        : CoreOptionEntry("off", "do not show image", 1) { }
};
...
static CoreOptionEntryList backgroundEntries(_entries, sizeof(_entries) / sizeof(CoreOptionEntry*));
